...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
  ...
  function srcAppTabsProfileProfilePageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_hk_apiprovider_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      _createClass(ProfilePage, [{
        ...
        value: function getUserId() {
          ...
          this.auth.postData(this.selectuser, "selectuserid").then(function (result) {
            ...
            _this.datauser = _this.resposeData.userData;
            _this.userData.puntos = _this.datauser.puntos;
          }, function (err) {
            console.log(err);
          });
        }
